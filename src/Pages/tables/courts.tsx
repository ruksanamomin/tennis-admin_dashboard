...
export default function Courts() {
    ...
    useEffect(() =>{
axios.get('http://localhost:5876/api/getcourts')
.then(res=>setCourt(res.data.data))
.catch(err=>console.log(err));
    },[])
  return (
    <>
    <div className='container'>
    <div className="  shadow-md overflow-x-auto sm:rounded-lg h-3/4 bg-gray-100 my-10 p-7 ">
      
        <div className='flex flex-row justify-evenly'>
        <h3 className='mr-96'>  Courts Table</h3>
     <CourtModal/>
